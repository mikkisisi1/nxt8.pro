...
export default function TopTicker() {
  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4 text-[10px] uppercase tracking-widest text-slate-500 overflow-hidden">
        <span className="text-brand-turquoise font-medium shrink-0">AI INDEX:</span>
